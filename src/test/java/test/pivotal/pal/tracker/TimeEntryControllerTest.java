...
public class TimeEntryControllerTest {
    ...
    public void testCreate() throws Exception {
        ...
        ResponseEntity<TimeEntry> response = controller.create(new TimeEntry(123, 456, LocalDate.parse("2017-01-08"), 8));
    ...
    public void testUpdate() throws Exception {
        ...
        ResponseEntity<TimeEntry> response = controller.update(1L, expected);
        assertThat(response.getStatusCode()).isEqualTo(HttpStatus.OK);
        assertThat(response.getBody()).isEqualTo(expected);
    }
    ...
    public void testUpdate_NotFound() throws Exception {
        ...
        ResponseEntity<TimeEntry> response = controller.update(1L, new TimeEntry());
        assertThat(response.getStatusCode()).isEqualTo(HttpStatus.NOT_FOUND);
    }
